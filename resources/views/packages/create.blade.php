...
@section('main_content')
    <div class="container">
        <form action="{{route("packages.store")}}" method='POST'>
            ...
            <input type="text" name="destination" id="destination" class="form-control" placeholder="" aria-describedby="helpId">
            <small id="destinationHelper" class="text-muted">Insert the package destination here</small>
            </div>
            <div class="form-group">
            <label for="price">Price</label>
            <input type="number" name="price" id="price" class="form-control" placeholder="" aria-describedby="helpId" step="0.01">
            <small id="priceHelper" class="text-muted">Insert the package price here</small>
            </div>
            <div class="form-group">
            <label for="image_url">Image URL</label>
            <input type="text" name="image_url" id="image_url" class="form-control" placeholder="" aria-describedby="helpId">
